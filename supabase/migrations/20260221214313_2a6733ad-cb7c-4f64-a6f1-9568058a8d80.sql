...
CREATE POLICY "Admin delete inspectors" ON public.inspectors
  FOR DELETE TO authenticated
  USING (public.has_ops_role(auth.uid(), 'admin'::ops_role));
...
CREATE POLICY "Admin delete uploads" ON public.uploads
  FOR DELETE TO authenticated
  USING (public.has_ops_role(auth.uid(), 'admin'::ops_role));
...
CREATE POLICY "Role update generated_documents" ON public.generated_documents
  FOR UPDATE TO authenticated
  USING (
    public.has_ops_role(auth.uid(), 'admin'::ops_role)
    OR public.has_ops_role(auth.uid(), 'office_manager'::ops_role)
...
-- =============================================
-- ROUTE_PLANS (field_ops can also INSERT)
-- =============================================
...
-- =============================================
-- ROUTE_PLAN_DAYS (field_ops can also INSERT)
-- =============================================
...
-- =============================================
-- ROUTE_PLAN_BUILDINGS (field_ops can also INSERT)
-- =============================================
